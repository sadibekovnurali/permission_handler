...
public class PermissionUtils {
    ...
    static int parseManifestName(String permission) {
        switch (permission) {
            ...
            case Manifest.permission.USE_BIOMETRIC:
                return PermissionConstants.PERMISSION_GROUP_USE_BIOMETRIC;
    ...
    static List<String> getManifestNames(Context context, @PermissionConstants.PermissionGroup int permission) {
        ...
        switch (permission) {
            ...
            case PermissionConstants.PERMISSION_GROUP_USE_BIOMETRIC:
                if (hasPermissionInManifest(context, permissionNames, Manifest.permission.USE_BIOMETRIC))
                    permissionNames.add(Manifest.permission.USE_BIOMETRIC);
                break;
